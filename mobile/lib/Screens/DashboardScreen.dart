              ...
              child: Column(
                ...
                children: [
                  ...
                  if (equipment.isNotEmpty) ...[
                    ...
                    ...equipment.map((item) {
                      Color statusColor =
                          item['status'] == 'online' ? Colors.green : Colors.red;
                      return Card(
                        child: ListTile(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    _buildSensorValue('Temp',
                                        '${log['temperature']}°C', Icons.thermostat),
                                    _buildSensorValue('Humidity',
                                        '${log['humidity']}%', Icons.water_drop),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                Row(
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                  children: [
                                    _buildSensorValue('Light', '${log['light_level']}',
                                        Icons.light_mode),
                                    _buildSensorValue(
                                        'Motion',
